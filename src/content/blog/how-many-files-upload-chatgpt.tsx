    ...
    <>
      ...
      <div className="not-prose rounded-xl border border-border bg-card p-5 mb-8">
        ...
        <p className="text-sm leading-normal text-muted-foreground">
          ...
          to combine unlimited files into one, then upload to ChatGPT. Free, works on any plan.
        </p>
      </div>

      <p>
        <strong>How many files can you upload to ChatGPT?</strong> It depends on your plan. ChatGPT Free allows 3 files per day. ChatGPT Plus allows approximately 80 files per 3-hour window. ChatGPT Pro allows unlimited uploads.
      </p>

      <p>
        This guide covers the exact file upload limits for every ChatGPT plan in 2026, including per-message limits, daily caps, and file size restrictions.
      </p>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border">
              ...
              <th className="text-left py-3 px-4 font-semibold">Files You Can Upload</th>
      ...
      <p>
        On ChatGPT&apos;s free plan, you can upload <strong>3 files per day</strong>. This limit resets every 24 hours.
      </p>

      <ul>
        <li><strong>Daily limit:</strong> 3 files total</li>
        <li><strong>Per message:</strong> Up to 3 files</li>
        <li><strong>File size:</strong> 512MB per file</li>
        <li><strong>Reset:</strong> Every 24 hours</li>
      </ul>

      <p>
        Once you hit the limit, you&apos;ll see the error: <em>&quot;You&apos;ve reached your file upload limit.&quot;</em> You&apos;ll need to wait until the next day or upgrade your plan.
      </p>

      <Callout variant="warning">
        <p>
          <strong>Note:</strong> The 3-file limit counts all file types - PDFs, documents, code files, images. Each upload uses one of your 3 daily slots.
        </p>
      </Callout>
      ...
      <ul>
        <li><strong>Rolling limit:</strong> ~80 files per 3-hour window</li>
        <li><strong>Per message:</strong> 10 files maximum</li>
        <li><strong>File size:</strong> 512MB per file</li>
        <li><strong>Reset:</strong> Rolling 3-hour window (not a hard reset)</li>
      </ul>

      <h3>How the Rolling Window Works</h3>

      <p>
        Unlike the Free plan&apos;s daily reset, Plus uses a <strong>rolling 3-hour window</strong>:
      </p>

      <ul>
        <li>Upload 80 files at 2:00 PM → can&apos;t upload more until 5:00 PM</li>
        <li>As time passes, older uploads &quot;expire&quot; and free up capacity</li>
        <li>You don&apos;t have to wait for a full reset - capacity becomes available gradually</li>
      </ul>

      <h3>The 10-File Per Message Limit</h3>

      <p>
        Even with Plus, you can only attach <strong>10 files per message</strong>. For larger projects, you&apos;ll need to upload in batches across multiple messages.
      </p>

      <Callout variant="info">
        <p>
          <strong>Example:</strong> To upload 50 files with Plus, you&apos;d need to send 5 separate messages with 10 files each. This is tedious for large codebases.
        </p>
      </Callout>
      ...
      <ul>
        <li><strong>Upload limit:</strong> Unlimited (subject to abuse guardrails)</li>
        <li><strong>Per message:</strong> No practical limit</li>
        <li><strong>File size:</strong> 512MB per file</li>
        <li><strong>Additional perks:</strong> Unlimited GPT-5.2 and advanced reasoning features</li>
      </ul>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border">
              ...
              <th className="text-left py-3 px-4 font-semibold">Maximum Size</th>
            </tr>
          </thead>
          <tbody>
            <tr className="border-b border-border">
      ...
      <ul>
        <li><strong>Documents:</strong> PDF, DOCX, DOC, PPTX, PPT, TXT, RTF, ODT</li>
        <li><strong>Spreadsheets:</strong> XLSX, XLS, CSV</li>
        <li><strong>Code:</strong> JS, TS, PY, Java, C, C++, Go, Rust, Ruby, PHP, and more</li>
        <li><strong>Images:</strong> PNG, JPG, JPEG, GIF, WEBP</li>
        <li><strong>Data:</strong> JSON, XML, HTML</li>
      </ul>

      <Callout variant="warning">
        <p>
          <strong>Not supported:</strong> Video files, audio files, executables (.exe, .app), and password-protected documents.
        </p>
      </Callout>
      ...
      <p>
        The most effective workaround: <strong>merge multiple files into one before uploading</strong>. ChatGPT counts files, not content. One file containing 100 documents counts as one upload.
      </p>

      <p>
        <Link href="/" className="text-primary hover:underline">OneFile</Link> does this automatically:
      </p>
      ...
      <ul>
        <li><strong>Free → Plus ($20/mo):</strong> Goes from 3 files/day to ~80 files/3 hours</li>
        <li><strong>Plus → Pro ($200/mo):</strong> Truly unlimited uploads</li>
      </ul>

      <p>
        See our{" "}
        <Link href="/blog/onefile-vs-chatgpt-plus-file-uploads" className="text-primary hover:underline">
      ...
      <h3>Why does ChatGPT say &quot;You&apos;ve reached your file upload limit&quot;?</h3>
      <p>
        This error appears when you&apos;ve hit your plan&apos;s upload cap. Free users see it after 3 files per day. Plus users see it after ~80 files in 3 hours. Wait for the limit to reset, upgrade your plan, or use{" "}
        <Link href="/" className="text-primary hover:underline">OneFile</Link> to combine files.
      </p>
      ...
      <p>
        ChatGPT limits you to 10 files per message (on Plus/Pro). To upload more at once, combine your files into a single file using{" "}
        <Link href="/" className="text-primary hover:underline">OneFile</Link>, then upload that one file containing all your content.
      </p>
      ...
      <div className="bg-card border border-border rounded-lg p-5 my-6">
        <ul className="text-sm space-y-2 mb-0">
          <li><strong>ChatGPT Free:</strong> 3 files per day, resets every 24 hours</li>
          <li><strong>ChatGPT Go:</strong> Extended uploads (more than Free)</li>
          <li><strong>ChatGPT Plus:</strong> ~80 files per 3 hours, 10 per message</li>
          <li><strong>ChatGPT Pro:</strong> Unlimited uploads</li>
          <li><strong>All plans:</strong> 512MB max file size</li>
        </ul>
      </div>

      <p>
        If you need to upload more files than your plan allows, the easiest solution is to{" "}
        <Link href="/" className="text-primary hover:underline">combine your files into one</Link>{" "}
        before uploading. This works on any plan and costs nothing.
      </p>

      <p>
        For a complete breakdown of all limits including message caps and feature access, see our{" "}
