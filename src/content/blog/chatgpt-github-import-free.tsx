    ...
    <>
      ...
      <div className="not-prose rounded-xl border border-border bg-card p-5 mb-8">
        ...
        <p className="text-sm leading-normal text-muted-foreground">
          ...
          {" "}lets you import any GitHub repository and convert it to a single file you can upload to ChatGPT. Free, no account required.
        </p>
      </div>

      <p>
        OpenAI launched the GitHub connector for ChatGPT in May 2025, letting users analyze code repositories directly within ChatGPT. There&apos;s one catch: <strong>it&apos;s only available on paid plans</strong>.
      </p>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border">
              ...
              <th className="text-left py-3 px-4 font-semibold">GitHub Access</th>
            </tr>
          </thead>
          <tbody>
            <tr className="border-b border-border">
      ...
      <p>
        <Link href="/" className="text-primary hover:underline">OneFile</Link> is a free, open-source tool that converts any GitHub repository into a single text file. You can then upload this file to ChatGPT (or any AI) for analysis.
      </p>
      ...
      <p>
        Click <strong>&quot;Download&quot;</strong> to save the combined output as a .txt file. This single file contains your entire repository in an AI-readable format.
      </p>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border">
              ...
              <th className="text-left py-3 px-4 font-semibold">ChatGPT Connector</th>
          ...
          <tbody>
            <tr className="border-b border-border">
              ...
              <td className="py-3 px-4 font-semibold text-green-600 dark:text-green-400">Free</td>
            </tr>
            <tr className="border-b border-border">
      ...
      <p>
        <Link href="/" className="text-primary hover:underline">OneFile</Link> gives you the same capability for free. Import any GitHub repository, get a single combined file, and upload it to ChatGPT in under 30 seconds.
      </p>
